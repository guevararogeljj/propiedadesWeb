<template>
  ...
  <!-- <div class="desktop-view">
      <div class="text-start">
        <div class="row mt-5">
          <div class="col-1"></div>
          <div class="col-11">
            <p class="title">{{ propertyInfo.title }}</p>
          </div>
        </div>
      </div>
      <div class="row m-5">
        <div class="col-9">
          <div class="row">
            ...
            <div class="col-1"></div>
            <div class="col-11">
              <div class="border-1 border-top border-secundary mt-4 mb-4"></div>
            </div>
          </div>
        ...
        <div class="col-3">
          <div class="row">
            <div class="col-12">
              <propiedadInfo
                class="mb-4"
                :Title="propertyInfo.type"
                :Description="propertyInfo.address"
                :StreetName="propertyInfo.address2"
                :Price="propertyInfo.price"
                :Favorite="propertyInfo.favorite"
                :OnClickShare="onClickShareButton"
                :OnClickPropInfo="onClickPropInfoButton"
                :OnClickFavorite="onClickFavoriteButton"
                :OnClickPropGetInfo="onClickPropGetInfoButton"
                :IsLogin="isLogin"
              />
            ...
            <div class="col-12">
              <informacion-legal
                :DictamenLegal="legal.dictamenLegal"
                :EstatusJuridico="legal.estadoJuridico"
                :NoCredito="legal.noCredito"
                :Saldos="legal.saldos"
                :TipoOperacion="legal.tipoOperacion"
                :ShowInfo="showlegalinfo"
                :OnCickBanner="onClickBannerButton"
                :OnClickInfoButton="onClickPropGetInfoButton"
                :NDAProcessActive="ndaprocess"
              />
            </div>
          </div>
        </div>
  ...
  <!-- <div class="mobile-view">
    ...
    <modal :visible="showPropInfo" :OnCloseTittleButton="onCloseModal">
      <p>
        Con gusto te atenderemos, en breve te estaremos contactando para darte mas
        información.
      </p>
    </modal>
    <modal-share
      ...
      style="width: 10em; !important margin-right: auto -2%; !important"
    >
      ...
      <div class="row justify-content-start">
        ...
        <div class="col-4 mr-2 mb-1" style="margin: auto -4%">
          <primarybutton
            Text="Compartir"
            :OnClickButton="onClickModalShareButton"
          />
        </div>
        <div class="col-4 mr-2 mb-1" style="margin: auto -2%; color: red">
          <label class="text-left labelCorreoError" v-if="validemail"
            >Correo invaildo</label
          >
        </div>
      </div>
    </modal-share>
    ...
    <ModalAccept
      :Show="showModalLoginRequest"
      Title="¡Necesitar iniciar sesión!"
      :OnCloseTittleButton="onClickCloseModalButton"
      :OnClickAcceptButton="onClickAcceptModalButton"
    >
      <p>¿Desea iniciar sesión?</p>
    </ModalAccept>
  
    <ModalCustom
        :Show="showPropGetInfo"
        Title="¡Ir a registro!"
        :OnCloseTittleButton="onClickCloseModalButton"
        :OnClickAcceptButton="onClickAcceptModalButtonGetInfo"
        TextButtonCancel=""
        TextButtonConfirm="CONTINUAR"
      >
      <p>Para obtener más información es necesario adiccionar tu registro, ten a la mano tu INE</p>
    </ModalCustom>
   -->
</template>
