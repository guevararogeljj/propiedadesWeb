<template>
  ...
  <!-- <div class="main-container">
      <div class="container wrapper-container pt-3 pb-4 mt-3">
        <div class="row mb-2">
          <div class="col-12 title justify-content-center">Capturar Datos</div>
          <div class="col-12 subtitle mt-1">Captura la siguiente información</div>
        </div>
        <form method="post">
          <div class="row justify-content-center">
            <div class="col-12 d-flex justify-content-center w-10">
                <div class="row rowBlock" >
                    <div class="col-6">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" :value="!data.RfcType" name="situacionFiscal" id="radioPersonaFisica" 
                            @change="changePersonType()" checked>
            ...
            <div class="col-12 d-flex justify-content-center w-95"> 
              <select name="Occupation" placeholder="Ocupación"
                      class="form-control form-control-custom disable"
                      v-model="data.ocuppation"
                      >
                <option value=0 selected disabled>Ocupación</option>
                <option v-for="o of occupationList" :key="o.id"
            ...
            <div class="col-12 d-flex justify-content-center w-95">
              <select name="maritalstatus" placeholder="Estado Civil"
                      class="form-control form-control-custom disable"
                      v-model="data.maritalstatus"
                      >
                <option value=0 selected disabled>Estado Civil</option>
                <option v-for="m of maritalStatusList" :key="m.id"
